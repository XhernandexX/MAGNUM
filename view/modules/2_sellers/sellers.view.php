...
<div class="col-mb-3">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 pb-1 mb-3">
        ...
        <div class="col-md-4">
            ...
            <div class="card-header">Modulo Ventas</div>
            <div class="card-body">
            <h2 class="card-title">Ventas</h2>
                        <p class="card-text">
        
                        <p class="card-text">En este modulo podrás administrar todas tus ventas.
                        <p>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class = "form-group">
            ...
            <select class="form-select" value="" name="txtRol" id="txtRol" placeholder="Rol">
                <option>Comprador Nuevo</option>
                <option>Comprador Frecuente</option>
            </select>
        </div>

        <div class = "form-group">
            <label for="txtUsuario">Producto:</label>
            <input type="text" required class="form-control" value="" name="txtProducto" id="txtProducto" placeholder="Producto">
        </div>
